import{S as De,i as Te,s as Be,k as s,a as m,r as a,l as r,m as v,h as c,c as h,u as t,p as u,L as je,b as xe,J as e,n as pe,E as me}from"../../chunks/index-a53775d9.js";import{c as Ge}from"../../chunks/shared-5d0213f0.js";function Ve(Je){let o,g,y,he,F,f,C,J,l,D,_,T,B,j,x,G,V,ye=" ",H,L,b,M,be=" ",R,q,S,K,O,I,U,$,k,z,ge=" ",Q,W,X,Y,i,Z,fe=" ",ee,ae,A,te,le,w,ne,se,_e=" ",re,oe,E,ie,ce,N,ue,de;return{c(){o=s("div"),g=s("div"),y=s("img"),F=m(),f=s("h1"),C=a("About Me"),J=m(),l=s("div"),D=a("Hello, I am "),_=s("span"),T=a("Alec Iberg"),B=a(` and I am a Full Stack
    ...
    `),k=s("span"),z=a("everyone."),Q=a(ge),W=m(),X=s("br"),Y=m(),i=s("div"),Z=a("As for my personal life, I really enjoy the"),ee=a(fe),ae=m(),A=s("span"),te=a("outdoors"),le=a(`- you can usually find me camping,
    hiking, or backpacking on a weekend. I am fortunate enough to
    `),w=s("span"),ne=a("live in Southern California"),se=a(` and be surrounded
    by some of our nation's best National Parks.`),re=a(_e),oe=m(),E=s("span"),ie=a("Joshua Tree"),ce=a(` is probably my favorite.
    ...
    provide value to the FinTech space and improve access to credit for
    `),k=r(n,"SPAN",{class:!0});var Ee=v(k);z=t(Ee,"everyone."),Ee.forEach(c),Q=t(n,ge),n.forEach(c),W=h(p),X=r(p,"BR",{}),Y=h(p),i=r(p,"DIV",{});var d=v(i);Z=t(d,"As for my personal life, I really enjoy the"),ee=t(d,fe),ae=h(d),A=r(d,"SPAN",{class:!0});var Ne=v(A);te=t(Ne,"outdoors"),Ne.forEach(c),le=t(d,`- you can usually find me camping,
    hiking, or backpacking on a weekend. I am fortunate enough to
    `),w=r(d,"SPAN",{class:!0});var Pe=v(w);ne=t(Pe,"live in Southern California"),Pe.forEach(c),se=t(d,` and be surrounded
    by some of our nation's best National Parks.`),re=t(d,_e),oe=h(d),E=r(d,"SPAN",{class:!0});var Fe=v(E);ie=t(Fe,"Joshua Tree"),Fe.forEach(c),ce=t(d,` is probably my favorite.
    Additionally, I am a huge College Football fan (GO BUCKS!), a big hockey
    fan, and I very much enjoy spending time with my dog,
