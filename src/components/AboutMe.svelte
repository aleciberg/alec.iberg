...
<div class="about-me-container">
  ...
  <div>
    Hello, I am <span class={'outdoors'}>Alec Iberg</span> and I am a Full Stack
    Developer.
    <br />
    <br />
  ...
  <div>
    ...
    <span class="outdoors">outdoors</span>- you can usually find me camping,
    hiking, or backpacking on a weekend. I am fortunate enough to
    <span class="target"> live in Southern California</span> and be surrounded
    by some of our nation's best National Parks.{' '}
    <span class={'outdoors'}>Joshua Tree</span> is probably my favorite.
    Additionally, I am a huge College Football fan (GO BUCKS!), a big hockey
    fan, and I very much enjoy spending time with my dog,
    <span class={'outdoors'}> Juniper.</span> She is a 2 year old Border Collie with
    unlimited energy.
  </div>
</div>
