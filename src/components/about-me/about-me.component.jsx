...
const AboutMe = () => {
  return (
    <div className="about-me">
      <img className="alec" src={alec} />
      <p>
        Hello, I'm <span className="target">Alec Iberg</span>, a full stack
        developer. I have been programming professionally for a bit over 3
        years.
      </p>
      <p>
      ...
      <p>
        ...
        probably my favorite. Additionally, I am a huge College Football fan (GO
        BUCKS!), a big hockey fan, and I very much enjoy spending time with my
        dog, Juniper. She is a 2 year old Border Collie with unlimited energy.
      </p>
    </div>
  );
};
